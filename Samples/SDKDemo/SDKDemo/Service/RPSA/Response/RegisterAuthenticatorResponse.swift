...
internal class RegisterAuthenticatorResponse : BaseNetworkResponse {

    internal var fidoRegistrationConfirmation : String?
    internal var fidoResponseCode : Int?
    internal var fidoResponseMsg : String?
    
    private let jsonFidoRegistrationConfirmationKey = "fidoRegistrationConfirmation"
    ...
    override init(json: Any) {
        ...
        if let jsonRepresentation = json as? [String : Any] {
            self.fidoRegistrationConfirmation   = jsonRepresentation[jsonFidoRegistrationConfirmationKey] as? String
